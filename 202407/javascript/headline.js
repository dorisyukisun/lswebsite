    ...
    a.fn.animatedHeadline = function(e) {
        ...
        function s(a) {
            ...
            if (a.parents(".ah-headline").hasClass("type")) {
                ...
                a.parents(".ah-headline").hasClass("clip") ? a.parents(".ah-words-wrapper").animate({
                    width: "2px"
                }, h.revealDuration, function() {
                    d(a, i),
                    t(i)
                }) : a.parents(".ah-headline").hasClass("loading-bar") ? (a.parents(".ah-words-wrapper").removeClass("is-loading"),
                d(a, i),
                setTimeout(function() {
                    s(i)
                }, h.barAnimationDelay),
        ...
        function t(a, i) {
            a.parents(".ah-headline").hasClass("type") ? (o(a.find("i").eq(0), a, !1, i),
            a.addClass("is-visible").removeClass("is-hidden")) : a.parents(".ah-headline").hasClass("clip") && a.parents(".ah-words-wrapper").animate({
                width: a.width() + 10
            }, h.revealDuration, function() {
                setTimeout(function() {
                    s(a)
        ...
        function o(a, i, e, n) {
            ...
            a.is(":last-child") ? (i.parents(".ah-headline").hasClass("type") && setTimeout(function() {
        ...
        this.each(function() {
            var i = a(this);
            if (h.animationType && ("type" == h.animationType || "rotate-2" == h.animationType || "rotate-3" == h.animationType || "scale" == h.animationType ? i.find(".ah-headline").addClass("letters " + h.animationType) : "clip" == h.animationType ? i.find(".ah-headline").addClass(h.animationType + " is-full-width") : i.find(".ah-headline").addClass(h.animationType)),
