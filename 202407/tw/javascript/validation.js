    ...
    e.extend(e.validator, {
        ...
        prototype: {
            ...
            showLabel: function(t, n) {
                ...
                !n && this.settings.success && (r.text(""),
            ...
            stopRequest: function(t, n) {
                ...
                n && this.pendingRequest === 0 && this.formSubmitted && this.form() ? (e(this.currentForm).submit(),
        ...
        attributeRules: function(t) {
            ...
            for (var i in e.validator.methods) {
                var s;
                i === "required" ? (s = r.get(0).getAttribute(i),
                s === "" && (s = !0),
                s = !!s) : s = r.attr(i),
        ...
        normalizeRules: function(t, n) {
            ...
            e.each(["rangelength"], function() {
                var n;
                t[this] && (e.isArray(t[this]) ? t[this] = [Number(t[this][0]), Number(t[this][1])] : typeof t[this] == "string" && (n = t[this].split(/[\s,]+/),
...
function(e) {
    ...
    if (e.ajaxPrefilter)
        ...
        e.ajax = function(r) {
            ...
            return i === "abort" ? (t[s] && t[s].abort(),
            t[s] = n.apply(this, arguments)) : n.apply(this, arguments)
        }
    }
}(jQuery),
function(e) {
